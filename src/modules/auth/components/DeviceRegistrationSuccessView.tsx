...
export interface DeviceRegistrationSuccessViewProps {
    onContinue: () => void
}

export const DeviceRegistrationSuccessView: React.FC<
    DeviceRegistrationSuccessViewProps
> = ({ onContinue }) => {
        ...
        <AuthCard>
            <div className="p-6 sm:p-8 text-center">
                ...
                <p className={`text-sm ${textMuted} mt-2 mb-8`}>
                    You have successfully registered this device. You can now
