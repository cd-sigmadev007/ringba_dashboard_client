...
const VIZ_ICONS: Record<VizType, React.ReactNode> = {
    table: (
        ...
        >
            <path
                strokeLinecap="round"
                d="M3 5h18M3 10h18M3 15h18M3 20h18M8 5v15M16 5v15"
            />
        </svg>
    ),
    bar: (
        ...
        >
            <path
                strokeLinecap="round"
                d="M4 20V10h4v10M10 20V6h4v14M16 20V13h4v7M2 20h20"
            />
        </svg>
    ),
    stacked_bar: (
        ...
        >
            ...
            <rect x="4" y="4" width="4" height="6" rx="1" />
    ...
    line: (
        <svg
            ...
            className="w-4 h-4"
        >
            <path strokeLinecap="round" d="M3 17l5-7 5 4 5-8" />
