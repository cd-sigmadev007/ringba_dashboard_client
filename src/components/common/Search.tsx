...
import { useClickOutside, useDebounceSearch } from '../../lib/hooks'
...
export const Search: React.FC<SearchProps> = ({
                        ...
                        ? [
                              {
                                  ...
                                  id: '1',
                                  address:
                                      '0x742d35Cc6634C0532925a3b8D9C77a4b3D4c71e9',
                                  name: 'Wallet 1',
                              },
                              {
                                  type: 'wallet',
                                  id: '2',
                                  address:
                                      '0x8ba1f109551bD432803012645Hac136c22C57b2a',
                                  name: 'Wallet 2',
                              },
                          ]
                        : [],
    ...
    const renderSuggestionItems = (items: Array<SearchItem>) => {
        ...
        <div className={cn('relative w-full', className)}>
            <Input
                ...
                className={cn(
                    ...
                    // Override focus background when custom background is provided
                    background && 'focus:!bg-[#001e3c]',
                    // Set text and placeholder colors for dark background
                    background && 'text-[#a1a5b7] placeholder:!text-[#a1a5b7]'
                )}
                shadow={false}
            />
